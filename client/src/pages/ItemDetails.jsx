    ...
    <div className="w-[90%]">
      ...
      >
        <div className="flex-1 flex-col">
          ...
          />
          <div className="relative w-full h-[5px] bg-[#4acd8d]"></div>
        </div>
      </div>
      <div className="mt-[60px] flex lg:flex-row gap-5">
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div className="w-[80%]">
            ...
            <div className="flex flex-row items-center flex-wrap gap-[18px]">
              <h4 className="font-epilogue font-semibold text-[14px] bg-[#4acd8d] rounded-md p-1 break-all">
                {state.city}
              </h4>
              <h4 className="font-epilogue font-semibold text-[14px] bg-[#4acd8d] rounded-md p-1 break-all">
                {state.country}
            ...
            <div className="mt-[20px]  flex flex-row items-center flex-wrap gap-[18px]">
              ...
              <div className="bg-[#4acd8d] rounded-[10px] p-[10px]">
                <h4 className="font-epilogue font-semibold text-[16px] rounded-md p-1 break-all">
                  Grant Account: {state.owner}
                </h4>
                <h4 className="font-epilogue font-semibold text-[16px] rounded-md p-1 break-all">
                  Stake-Power: {state.stakePower}
                </h4>
              </div>
            </div>
          </div>
        ...
        <div className="w-[90%] flex-1 flex-col gap-5 justify-left">
          <div
            className="p-[20px] border-[3px] flex-col gap-5 rounded-[10px] items-center border-[#4acd8d] space-y-4
                    "
          >
            <div>
              <CustomButton
            ...
            <div className="mt-[4]">
              ...
              />
              <h4 className="font-epilogue font-bold text-[16px] rounded-md p-1 break-all">
                Current Pollution Index:
              </h4>
              <h4 className="font-epilogue w-[10%] font-semibold text-[14px] text-center bg-[#4acd8d] rounded-md p-1 break-all">
                {state.pollutionIndex}
              </h4>
            </div>
            <div className="mt-[40px]">
              ...
              <h4 className="font-epilogue w-[50%] font-semibold text-[14px] text-left bg-[#4acd8d] rounded-md p-1 break-all">
                {state.totalReceived}
              </h4>
            </div>
          </div>
